...
- **Sentiments initiaux** : Décrivez vos émotions et attentes avant de commencer le stage.
- **Raisons de ces sentiments** : Expliquez pourquoi vous ressentiez de l'enthousiasme et de l'incertitude (nouveau domaine, nouvelles responsabilités, etc.).
- **Objectifs personnels initiaux** : Mentionnez vos objectifs personnels en début de stage.
...
- **Définition de la cybersécurité** : La cybersécurité consiste à protéger les systèmes, les réseaux et les programmes contre les attaques numériques. @noauthor_quest-ce_nodate Assurer la sécurité du système d'information (SSI) consiste à gérer les risques de sécurité selon une démarche en trois étapes: lister, évaluer et traiter les risques. @noauthor_dechiffrer_nodate La notion de SOC, *Security Operation Center*, devient essentiel pour mettre en oeuvre une politique de cybersécurité. UN SOC, doit "monitorer l'ensemble des composants d'un système d'information et être capable de détecter et de sélectionner parmi des milliars d'octets des éléments caractéritiques d'une cyberattaque" @noauthor_cybersecurite_2024.
- **Importance de la cybersécurité** : Expliquez pourquoi la cybersécurité est cruciale pour les entreprises modernes.
- **Liens avec le machine learning** : Mentionnez brièvement comment le machine learning peut aider en cybersécurité, sans trop détailler (pour ne pas anticiper les autres sections).
