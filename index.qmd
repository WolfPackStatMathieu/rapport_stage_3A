...
Dans le cadre du stage, il était intéressant de travailler sur les requêtes http. En effet, le SOC cherche à monter un SIEM associé à un puit de logs (à définir). Pour faire cela, il était intéressant d'adopter une démarche globale plutôt qu'une démarche spécialisée dans la cybersécurité.
...
1. **Alignement avec mes objectifs de carrière** : 

2. **Développement de compétences spécifiques** : 
